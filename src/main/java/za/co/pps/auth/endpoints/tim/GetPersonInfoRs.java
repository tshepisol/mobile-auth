 ...
 *         &lt;element name="passportNnumber" type="{http://www.w3.org/2001/XMLSchema}string"/>
 ...
 *         &lt;element name="mobileContryCode" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="otpPreference" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "GetPersonInfoRs")
public class GetPersonInfoRs {
    ...
    @XmlElement(required = true)
    protected String passportNnumber;
    @XmlElement(required = true)
    ...
    @XmlElement(required = true)
    protected String mobileContryCode;
    @XmlElement(required = true)
    protected String otpPreference;
    @XmlElement(required = true)
    ...
    /**
     * Gets the value of the passportNnumber property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPassportNnumber() {
        return passportNnumber;
    }

    /**
     * Sets the value of the passportNnumber property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPassportNnumber(String value) {
        this.passportNnumber = value;
    }
    ...
    /**
     * Gets the value of the mobileContryCode property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the mobileContryCode property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
    ...
    public void setMobileContryCode(String value) {
        this.mobileContryCode = value;
    }

    /**
     * Gets the value of the otpPreference property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the otpPreference property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setOtpPreference(String value) {
        this.otpPreference = value;
    }
    ...
    public String toString() {
        return "GetPersonInfoRs{" +
                ...
                ", initials='" + initials + '\'' +
                ", idNumber='" + idNumber + '\'' +
                ", passportNnumber='" + passportNnumber + '\'' +
                ", username='" + username + '\'' +
                ", password='" + password + '\'' +
                ", memberNo='" + memberNo + '\'' +
                ", partyID='" + partyID + '\'' +
